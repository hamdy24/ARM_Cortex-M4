 ...
 *	Brief		: This file contains all interfaces implementation for the GPIO
 */
...
ES_t GPIO_enuSetPinValue(GPIO_Pins_t Copy_u8PinID ,GPIO_Logic_t Copy_enuValue){
	...
	if(Copy_u8PinID <= GPIO_PC15 && Copy_u8PinID >= GPIO_PA0 ){
		...
		if(Copy_enuValue == GPIO_High || Copy_enuValue == GPIO_Low){
...
ES_t GPIO_enuSetPinValue_Direct(GPIO_Pins_t Copy_u8PinID ,GPIO_Logic_t Copy_enuValue){
	...
	if(Copy_u8PinID <= GPIO_PC15 && Copy_u8PinID >= GPIO_PA0 ){
		...
		}else if(Copy_enuValue == GPIO_Low){
